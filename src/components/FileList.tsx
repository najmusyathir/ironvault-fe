...
// Dummy data for demo purposes when backend returns 404
const DUMMY_FILES: RoomFile[] = [
  {
    id: 1,
    room_id: 1,
    user_id: 1,
    filename: "project-proposal.pdf",
    original_filename: "Project Proposal 2024.pdf",
    file_size: 2048576,
    file_type: "application/pdf",
    category: FileCategory.DOCUMENT,
    description: "Q4 project proposal with budget estimates",
    storage_path: "/files/room1/project-proposal.pdf",
    is_encrypted: true,
    status: "active",
  ...
  },
  {
    ...
    original_filename: "Team Photo 2024.jpg",
    file_size: 3145728,
    file_type: "image/jpeg",
    category: FileCategory.IMAGE,
    description: "Team building event photo",
    storage_path: "/files/room1/team-photo.jpg",
    is_encrypted: false,
    status: "active",
    upload_date: new Date(Date.now() - 86400000).toISOString(), // 1 day ago
    last_accessed: new Date(Date.now() - 43200000).toISOString(), // 12 hours ago
  ...
  },
  {
    ...
    original_filename: "Quarterly Review Presentation.pptx",
    file_size: 5242880,
    file_type: "application/vnd.openxmlformats-officedocument.presentationml.presentation",
    category: FileCategory.DOCUMENT,
    description: "Q3 quarterly review presentation",
    storage_path: "/files/room1/presentation.pptx",
    is_encrypted: true,
    status: "active",
  ...
  },
  {
    ...
    storage_path: "/files/room1/demo-video.mp4",
    is_encrypted: false,
    status: "active",
  ...
  },
  {
    ...
    original_filename: "Project Source Code.zip",
    file_size: 8388608,
    file_type: "application/zip",
    category: FileCategory.ARCHIVE,
    description: "Complete project source code archive",
    storage_path: "/files/room1/source-code.zip",
    is_encrypted: true,
    status: "active",
    upload_date: new Date(Date.now() - 345600000).toISOString(), // 4 days ago
    last_accessed: new Date(Date.now() - 259200000).toISOString(), // 3 days ago
  ...
  },
  {
    ...
    original_filename: "Weekly Meeting Notes.txt",
    file_size: 16384,
    file_type: "text/plain",
    category: FileCategory.DOCUMENT,
    description: "Weekly team meeting notes and action items",
    storage_path: "/files/room1/meeting-notes.txt",
    is_encrypted: false,
    status: "active",
    upload_date: new Date(Date.now() - 432000000).toISOString(), // 5 days ago
    last_accessed: new Date(Date.now() - 345600000).toISOString(), // 4 days ago
...
export function FileList({ roomId, refreshTrigger }: FileListProps) {
  ...
  const loadFiles = async () => {
    try {
      ...
      console.log("API returned 404, using dummy data for demo");
      // Use dummy data for demo purposes when backend is not ready
